...
//
//namespace Zap {
//	PathTracer::PathTracer(RenderTargetHandle<> target, Scene* pScene)
//		: m_target(target), m_pScene(pScene)
//	{
...
//
//		uint32_t imageCount = m_target->getImageCount();
//		m_targetDescriptorSets.resize(imageCount);
//		for (uint32_t i = 0; i < imageCount; i++) {
//			m_target->getDescriptor
//		}
//
